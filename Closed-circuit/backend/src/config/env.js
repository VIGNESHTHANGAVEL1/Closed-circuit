...
export const config = {
  ...
  spaces: {
    ...
    flowFolder: (process.env.DO_SPACES_FLOW_FOLDER || 'flow').replace(/^\/|\/$/g, ''),
    voiceFolder: (process.env.DO_SPACES_VOICE_FOLDER || 'voice').replace(/^\/|\/$/g, ''),
    familyFolder: (process.env.DO_SPACES_FAMILY_FOLDER || 'families').replace(/^\/|\/$/g, ''),
