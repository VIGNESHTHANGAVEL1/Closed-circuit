...
const bodyTextClass =
  'text-base sm:text-lg md:text-xl text-slate-400 font-normal leading-snug sm:leading-normal';
...
function Section({ title, children, index = 0 }) {
  return (
    ...
    >
      <Card className="p-4 sm:p-5 md:p-6 border border-white/10 bg-gradient-to-br from-white/[0.03] to-white/[0.01]">
        <h2 className="font-display text-lg sm:text-xl md:text-2xl font-bold text-white tracking-tight">
          {title}
        </h2>
        <div className={`mt-3 space-y-2.5 ${bodyTextClass}`}>{children}</div>
      </Card>
    </motion.div>
  );
}
          ...
          <div className="space-y-4 md:space-y-5">
            <Section title="Founded by Ramesh" index={0}>
              <p>
                ...
                extensively as a Product Manager and Product Owner, gaining experience in taking technology products from
                an initial idea through design, architecture, development, strategy, and final delivery.
              </p>
              <p>
            ...
            <Section title="Why We Built Closed Circuit" index={1}>
              <p>
                ...
                platform that puts privacy first. Closed Circuit has been developed with a strong focus on the following
                principles:
              </p>
              ...
              <p>
                ...
                has been developed. Our vision is to create technology that is not just another social platform, but a
                secure, private, and user-controlled digital space for individuals, families, communities, and
                organizations.
              </p>
            </Section>
            ...
            <Section title="Our Company" index={2}>
              <p>
                Closed Circuit AI Private Limited was incorporated on 12 September 2022. CIN: U72900KA2022PTC165991.
            ...
            <Section title="Focused Development. Experienced Team." index={3}>
              <p>
                ...
                user-friendly digital communication platform. Our team brings experience across product development,
                software engineering, system administration, testing, and technology implementation. Every stage of
                development has been approached with careful planning, implementation, and verification.
              </p>
              <p>
                Our development process focuses on understanding user needs, designing practical solutions, implementing
                them carefully, and testing them thoroughly. We have tested the platform using more than 1,000 test
                cases. Our testing team has carefully executed and verified each test case to ensure that the
                implemented features work as intended and that the platform delivers a reliable user experience.
              </p>
            ...
            <Section title="Your Privacy. Your Data. Your Control." index={4}>
              <p>
                ...
                communications remain accessible only to you and the people you choose to share them with. Even when our
                developers or system administrators access the database or cloud infrastructure for maintenance or
                troubleshooting, they cannot view your original data in readable form where encryption is applied. They
                can see only the encrypted representation of the data.
              </p>
              <p>
            ...
            <Section title="Try Before You Subscribe" index={5}>
              <p>
                ...
                30-day money-back guarantee. You do not need to pay anything before starting your trial.
              </p>
              <p>
                ...
                decision. After your 1-week free trial, you can decide whether to subscribe for one year.
              </p>
              <p>
                Only if you are fully satisfied with the platform and its implementation, you can proceed with the annual
                subscription. Our goal is simple: Give you the opportunity to experience Closed Circuit first, understand
                its value, and then make your decision with confidence.
              </p>
            </Section>
            ...
            >
              <Card className="p-4 sm:p-5 md:p-6 border border-white/10 bg-gradient-to-br from-white/[0.03] to-white/[0.01]">
                ...
                <div className={`mt-3 ${bodyTextClass}`}>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-x-12">
                    ...
                    <div className="space-y-0.5 sm:pt-0">
                      <p>Email: cc@closedcircuit.in</p>
                      <p>Mobile: +91 82175 43446</p>
                    </div>
                  </div>
                  <p className="mt-4 pt-4 border-t border-white/10 text-center">
                    Google Maps:{' '}
                    <a
                      href="https://maps.app.goo.gl/cZ67tsC2ryFeegSg6"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 break-all sm:break-normal"
                    >
