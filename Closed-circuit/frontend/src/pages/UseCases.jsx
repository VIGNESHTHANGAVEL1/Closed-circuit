  ...
  return (
    <div className="flex flex-wrap gap-2">
      {items.map((item) => (
        <span
          key={item}
          className="rounded-full border border-white/10 bg-white/[0.04] px-3 py-1.5 text-xs font-semibold text-slate-300 backdrop-blur-sm transition hover:border-indigo-500/40 hover:bg-indigo-500/10"
        >
          {item}
        </span>
      ))}
    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="bg-[#030712] text-slate-300">
      ...
      <section className="section-y-sm relative border-b border-white/5 bg-[#030712]">
        <div className="page-container">
          <motion.p variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-sm font-bold uppercase tracking-[0.3em] text-indigo-400">
            Why Closed Circuit
          </motion.p>
      ...
      <section className="section-y-sm relative border-b border-white/5">
        <div className="page-container grid items-center gap-5 lg:grid-cols-2">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            <p className="text-sm font-bold uppercase tracking-[0.3em] text-purple-400">Private Network</p>
            <h2 className="font-display mt-2 text-3xl font-bold text-white md:text-4xl">{privateNetwork.title}</h2>
            <p className="mt-3 text-base leading-relaxed text-slate-400">{privateNetwork.text}</p>
          ...
          <div className="grid items-start gap-5 lg:grid-cols-[1fr_1.1fr]">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              <div className="flex items-center gap-3 mb-3">
                ...
                <h2 className="font-display text-2xl font-bold text-white md:text-3xl">{smartGroups.title}</h2>
              </div>
              <p className="text-base text-slate-400 leading-relaxed">{smartGroups.text}</p>
            </motion.div>
          ...
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            <Card className="h-full border border-white/10 bg-white/[0.02] p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-display text-xl font-bold text-white">{announcements.title}</h3>
              </div>
              <p className="text-sm text-slate-400 mb-4">{announcements.text}</p>
          ...
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0.08}>
            <Card className="h-full border border-white/10 bg-white/[0.02] p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-display text-xl font-bold text-white">{events.title}</h3>
              </div>
              <p className="text-sm text-slate-400 mb-4">{events.text}</p>
        ...
        <div className="page-container space-y-5">
          <div className="grid items-center gap-5 lg:grid-cols-2">
            ...
            <Card className="border border-white/10 p-6">
              ...
              <h3 className="font-display text-2xl font-bold text-white">{photos.title}</h3>
              <p className="mt-2 text-sm text-slate-400">{photos.text}</p>
          ...
          <div className="grid items-center gap-5 lg:grid-cols-2">
            <Card className="order-2 lg:order-1 border border-white/10 p-6">
              ...
              <h3 className="font-display text-2xl font-bold text-white">{documents.title}</h3>
              <p className="mt-2 text-sm text-slate-400">{documents.text}</p>
          ...
          <Card className="border border-white/10 bg-gradient-to-br from-purple-500/10 via-white/[0.02] to-indigo-500/10 p-6 md:p-8">
            <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
              <div className="md:max-w-md">
                ...
                <h3 className="font-display text-2xl font-bold text-white">{polls.title}</h3>
                <p className="mt-2 text-sm text-slate-400">{polls.text}</p>
              </div>
      ...
      <section className="section-y-sm relative bg-[#0f172a]/40 border-b border-white/5">
        <div className="page-container">
          <p className="text-sm font-bold uppercase tracking-[0.3em] text-indigo-400 mb-2">Access Control</p>
      ...
      <section className="section-y-sm relative bg-[#0f172a]/40 border-b border-white/5">
        <div className="page-container grid gap-5 lg:grid-cols-2">
          <Card className="border border-white/10 p-6 bg-gradient-to-br from-indigo-500/5 to-transparent">
            ...
            <h3 className="font-display text-2xl font-bold text-white">Why Organizations Choose Closed Circuit</h3>
          ...
          <Card className="border border-white/10 p-6 flex flex-col justify-center">
            ...
            <p className="mt-3 text-sm leading-relaxed text-slate-400">{onePlatform.text}</p>
            <div className="mt-5">
      ...
      <section className="section-y-sm relative border-b border-white/5">
        <div className="page-container">
          <Card className="border border-white/10 bg-gradient-to-br from-indigo-500/10 via-purple-500/5 to-transparent p-8 text-center">
            <h2 className="font-display text-3xl font-bold text-white md:text-4xl">{closingHighlight.title}</h2>
            <p className="mx-auto mt-4 max-w-3xl text-base leading-relaxed text-slate-400">{closingHighlight.text}</p>
          </Card>
        </div>
      </section>
        ...
        <div className="page-container relative text-center">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            <h2 className="font-display text-3xl font-bold text-white md:text-4xl">
              Start Building Your Private Business Network
            </h2>
            ...
            <Link
              to="/contact"
              className="group mt-6 inline-flex items-center gap-2 rounded-full bg-white px-8 py-3.5 text-sm font-bold text-slate-900 shadow-[0_0_30px_rgba(255,255,255,0.25)] transition hover:-translate-y-0.5 hover:shadow-[0_0_40px_rgba(255,255,255,0.4)]"
            >
              Contact Us
