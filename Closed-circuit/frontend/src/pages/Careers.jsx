...
export default function Careers() {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="bg-[#030712] text-slate-300">
      <Hero
        title="Careers at Closed Circuit"
        subtitle="Join our Inside Sales Team and help customers discover a private, secure communication platform."
        ...
        <div className="page-container space-y-5">
          <Card className="p-5 sm:p-6 md:p-8 border border-white/10 bg-gradient-to-br from-indigo-500/10 to-transparent">
            <div className="flex flex-wrap items-center gap-3 mb-4">
              <span className="inline-flex items-center gap-2 rounded-full border border-indigo-500/30 bg-indigo-500/10 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-indigo-300">
                <Briefcase size={14} /> Now Hiring
              </span>
              <span className="inline-flex items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-emerald-300">
            ...
            <div className={`mt-3 space-y-2.5 ${bodyText}`}>
              <p>Currently, we have an opening only for the Inside Sales Executive position.</p>
              <p>
                Closed Circuit is looking for motivated and responsible people to join our Inside Sales Team. This is a
                Work From Home opportunity, and candidates from any location can apply.
              </p>
            </div>
          </Card>
            ...
            <div className={`mt-4 space-y-4 ${bodyText}`}>
              ...
              <div className="rounded-xl border border-purple-500/20 bg-purple-500/5 p-4 sm:p-5">
                ...
                <p className="mt-3 flex flex-wrap items-center gap-2">
                  <span>Please watch the career video completely and understand the opportunity before submitting the application.</span>
                  <VideoLinkButton variant="career" onClick={() => setCareerVideoOpen(true)}>Click here to watch</VideoLinkButton>
                </p>
                <p className="mt-3">
          ...
          <div className="grid gap-5 lg:grid-cols-2">
            <Card className="p-5 sm:p-6 border border-white/10 bg-white/[0.02]">
              ...
              <div className={`mt-4 space-y-2 ${bodyText}`}>
                <p className="flex items-center gap-2"><Clock size={16} className="text-indigo-400" /> Work Schedule: Monday to Saturday</p>
                <p className="flex items-center gap-2"><Clock size={16} className="text-indigo-400" /> Working Hours: 10:00 AM to 7:00 PM</p>
              </div>
